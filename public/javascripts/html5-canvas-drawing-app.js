...
function prepareCanvas()
{
  ...
  var t=document.createTextNode("SEND ME");
  btn.id = "btnSend";
...
/*  var btnC=document.createElement("BUTTON");
  ...
  btnC.onclick=function(){
   ...
   btnC.appendChild(t);
   btnC.appendChild(t);
   canvasDiv.appendChild(btnC);
*/ 
  
  var btnC=document.createElement("BUTTON");
  t=document.createTextNode("eraser");
  btnC.id = "btnclear";
  btnC.onclick=function(){
     		curTool = "eraser";
    		curSize = "huge";
 ...
 var btnC=document.createElement("BUTTON");
  t=document.createTextNode("marker");
  btnC.id = "btnmarker";
  btnC.onclick=function(){
     curTool = "marker";
    curSize = "normal";
   ...
   canvasDiv.appendChild(btnC);
    ...
    var btnC=document.createElement("BUTTON");
    t=document.createTextNode("crayon");
    btnC.id = "btncrayon";
    btnC.onclick=function(){
    curTool = "crayon";
     curSize = "normal";
